# Shipping-point wholesale boundary

Packet ID: `shipping-point-boundary`
...
What does a shipping-point report not establish?

## Proposed factual claims

### agricultural-statistic

USDA Market News describes first-handler or wholesale market conditions; the selected records do not support a consumer shelf-price claim.
...
- `mmn-1662`: National Shipping Point Trends Report
...
- `evidence` — Shipping-point wholesale boundary evidence; 1 evidence row(s)
