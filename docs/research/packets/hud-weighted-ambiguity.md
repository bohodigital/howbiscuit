# Weighted HUD ambiguity

Packet ID: `hud-weighted-ambiguity`
...
How should a ZIP spanning counties be described?

## Proposed factual claims

### agricultural-statistic

HUD’s residential crosswalk assigns ZIP 60010 across four counties; Lake County, Illinois has the largest listed residential weight at 52.7421%, so the ZIP must not be described as belonging exclusively to Cook County.

Evidence: `hud-60010-county-17031`, `hud-60010-county-17097`, `hud-60010-cbsa-16980`
...
- `hud-60010-county-17031`: county
- `hud-60010-county-17097`: county
- `hud-60010-cbsa-16980`: cbsa
...
- `evidence` — Weighted HUD ambiguity evidence; 3 evidence row(s)
