...
Pair a USDA weekly market report definition with annual crop production.
...
Evidence: `mmn-1655`, `nass-rice-2025`
...
- `mmn-1655`: National Weekly Rice Summary
- `nass-rice-2025`: rice
...
- `evidence` — Rice market context evidence; 2 evidence row(s)
