# Northwest Indiana energy context

Packet ID: `northwest-indiana-energy-context`
...
Pair ZIP-to-metro context with Indiana residential energy benchmarks.

## Proposed factual claims

### aggregate-energy-benchmark

The selected approved source record hud-46402-cbsa provides bounded historical context and does not support a live, personalized, or retail claim.

Evidence: `hud-46402-cbsa`, `eia-electricity-residential-in-2026-05`, `eia-natural-gas-residential-in-2026-04`
...
- `hud-46402-cbsa`: cbsa
- `eia-electricity-residential-in-2026-05`: electricity-residential-in
...
- `evidence` — Northwest Indiana energy context evidence; 3 evidence row(s)

## Suggested charts

- `trend` — Northwest Indiana energy context trend; x: `period`, y: `value`
