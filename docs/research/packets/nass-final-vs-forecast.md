# NASS final versus forecast rows

Packet ID: `nass-final-vs-forecast`
...
How are final and forecast statistics kept distinct?
...
Evidence: `nass-soybeans-2025`, `nass-soybeans-2025-nov-forecast`
...
- `nass-soybeans-2025-nov-forecast`: soybeans
...
- `evidence` — NASS final versus forecast rows evidence; 2 evidence row(s)

## Suggested charts

- `trend` — NASS final versus forecast rows trend; x: `period`, y: `value`
