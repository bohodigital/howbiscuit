# Midwest egg inventory

Packet ID: `egg-inventory-context`
...
Explain the inventory unit and why it is not a consumer price.
...
Evidence: `mmn-1427`, `mmn-1427-midwest-2026-07-20`
...
- `mmn-1427`: National Weekly Shell Egg Inventory
...
- `evidence` — Midwest egg inventory evidence; 2 evidence row(s)
