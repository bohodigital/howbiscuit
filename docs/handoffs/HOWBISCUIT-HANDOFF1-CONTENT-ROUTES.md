...
| `/tools/agricultural-market-context-browser/` | Create package-driven 200 | — | `/tools/agricultural-market-context-browser/` | Included | Included | Handoff 3.1 publishes the approved static USDA Market News context browser. |
| `/tools/household-energy-benchmark-explorer/` | Create package-driven 200 | — | `/tools/household-energy-benchmark-explorer/` | Included | Included | Handoff 3.1 publishes the approved static EIA benchmark explorer. |
| `/tools/us-crop-production-trend-explorer/` | Create package-driven 200 | — | `/tools/us-crop-production-trend-explorer/` | Included | Included | Handoff 3.1 publishes the approved static NASS trend explorer. |
| `/tools/usda-staple-food-identity-explorer/` | Create package-driven 200 | — | `/tools/usda-staple-food-identity-explorer/` | Included | Included | Handoff 3.1 publishes approved FoodData identities and fails closed on incomplete nutrients. |
| `/tools/zip-to-metro-relationship-explainer/` | Create package-driven 200 | — | `/tools/zip-to-metro-relationship-explainer/` | Included | Included | Handoff 3.1 publishes the approved weighted HUD relationship explainer. |
