...
\hbtype{guide}
\hbpriority{30}
\hbanswer{Salt lowers the freezing point of the thin water layer touching ice, creating brine that can melt more ice until temperature, concentration, or available liquid water reaches a practical limit.}
\hbproblem{I need to clear ice safely}
\hbtesting{not-hands-on-tested}
\hbdisclosure{no-paid-links}
\hbevidence{Researched}
